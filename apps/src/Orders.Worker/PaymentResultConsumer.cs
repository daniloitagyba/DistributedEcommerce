...
public sealed class PaymentResultConsumer(
    ...
    IPaymentResultDeadLetterPublisher deadLetterPublisher,
    ILogger<PaymentResultConsumer> logger) : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        consumer.Subscribe(_options.PaymentResultTopic);
        WorkerLog.Started(logger, _options.PaymentResultTopic, _options.ConsumerGroup);
